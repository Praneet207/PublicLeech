...
class Config(object):
    ...
    TG_BOT_TOKEN = get_config("5341638080:AAF8AEKUCCSoD0Fol7QMUIhXINfPvNM_0_0", should_prompt=True)
    # The Telegram API things
    APP_ID = int(get_config("7028372", should_prompt=True))
    API_HASH = get_config("10bc5c7771a121c180ab8859ab438bb8", should_prompt=True)
